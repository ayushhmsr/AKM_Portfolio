...
export default function Home() {
  ...
  return (
    <main style={{ minHeight: '100vh', paddingTop: '80px', paddingBottom: '2.5rem', position: 'relative', overflowX: 'hidden' }}>
      ...
      {/* ── 2. SECTION 01 // SOFTWARE ARCHITECTURE & FRONTEND CRAFT ── */}
      <section id="about" style={{ padding: '3rem 0 3.5rem' }}>
        <div className="container-custom">
          ...
          >
            {/* Left Card: Academic & SWE Foundation */}
            ...
            {/* Right Card: Full-Stack & API Integration */}
            <ScrollReveal direction="up" delay={120}>
              <div
                className="editorial-card"
                style={{
      ...
      {/* ── 3. SECTION 02 // STACK & CAPABILITIES ── */}
      ...
      {/* ── 4. SECTION 03 // PROFESSIONAL WORK HISTORY ── */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
                ...
                >
                  <div style={{ padding: '1rem', background: '#f8fafc', borderRadius: '12px', border: '1px solid #f1f5f9' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.45rem', marginBottom: '0.35rem' }}>
                      ...
                      <h4 style={{ fontSize: '0.86rem', fontWeight: 800, color: '#09090b' }}>
                        First Web Presence
                      </h4>
                    </div>
            ...
            <ScrollReveal direction="up" delay={120}>
              ...
              >
                ...
                >
                  <div style={{ padding: '1rem', background: '#f8fafc', borderRadius: '12px', border: '1px solid #f1f5f9' }}>
                    <h4 style={{ fontSize: '0.86rem', fontWeight: 800, color: '#09090b', marginBottom: '0.35rem' }}>
                      SPA Feature Shipping
                    </h4>
                    <p style={{ color: '#64748b', fontSize: '0.8rem', lineHeight: 1.55 }}>
      ...
      {/* ── 5. SECTION 04 // FEATURED PRODUCTION PROJECTS ── */}
        ...
        <div className="container-custom">
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                    <a
                      href="https://coinscopee.netlify.app"
                      target="_blank"
                      rel="noreferrer"
                ...
                >
                  ...
                  <svg viewBox="0 0 300 90" style={{ width: '100%', height: '90px' }}>
                    ...
                    <path
                      d="M 0,65 Q 40,75 80,45 T 160,35 T 240,20 T 300,30 L 300,90 L 0,90 Z"
                      fill="url(#chartGrad)"
                    />
                    <path
                      d="M 0,65 Q 40,75 80,45 T 160,35 T 240,20 T 300,30"
                      fill="none"
                      stroke="#10b981"
                      strokeWidth="2.5"
                    />
          ...
          <ScrollReveal direction="up" delay={120}>
            ...
            >
              ...
              >
                {/* Left Dark Resume Builder Mockup */}
                <div
                  className="dark-mockup-card"
                  style={{
                    padding: '1.5rem',
                ...
                <div>
                  ...
                  <p style={{ color: '#52525b', fontSize: '0.86rem', lineHeight: 1.6, marginBottom: '1.25rem' }}>
                    Built a cloud-hosted React SPA with 2+ reusable components to support dynamic, real-time resume generation. Tested across 3+ browsers and reduced the resume creation workflow to under 5 minutes with streamlined input-to-export UX.
                  </p>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                    <a
                      href="https://resumify-airesumebuilderr.netlify.app"
                      target="_blank"
                      rel="noreferrer"
                      className="btn-dark-pill"
                    >
      ...
      {/* ── 6. SECTION 05 // VERIFIED CERTIFICATIONS & EDUCATION BANNER ── */}
      ...
      {/* ── 7. SECTION 06 // DIRECT INQUIRY & CONTACT ── */}
      <section id="contact" style={{ padding: '2.5rem 0 4.5rem' }}>
        <div className="container-custom">
          ...
          >
            ...
            {/* Right Form: Direct Inquiry Terminal */}
              ...
              >
                ...
                <form ref={formRef} onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 130px), 1fr))', gap: '0.85rem' }}>
                    <div>
                      <label style={{ fontSize: '0.72rem', color: '#64748b', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.04em', display: 'block', marginBottom: '0.35rem' }}>
                        Your name
                      </label>
                      <input
                        name="from_name"
